            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {((selectedProject.priority || '') + '').charAt(0).toUpperCase() + ((selectedProject.priority || '') + '').substring(1)}
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {((selectedProject.status || '') + '').charAt(0).toUpperCase() + ((selectedProject.status || '') + '').substring(1)}
                </div>
              </div>
